...
@Service("deptService")
@Transactional
public class DeptServiceImpl extends IdService implements CascadeEntityService {
	@Autowired
	...
	public PageVO<CascadeEntity> getPageListByQuery(CascadeEntity query, PageVO<CascadeEntity> pageVO) throws Exception {
		// 封装 mapper 查询文件对象
		Map<String,Object> map = QueryMapUtil.getQueryMap("sys_dept",query);
	...
	public boolean save(CascadeEntity entity) throws Exception {
		// 封装 mapper 查询文件对象
		Map<String,Object> map = QueryMapUtil.getQueryMap("sys_dept",entity);
	...
	public CascadeEntity getById(String id) throws Exception {
		...
		// 封装 mapper 查询文件对象
		Map<String,Object> map = QueryMapUtil.getQueryMap("sys_dept",CascadeEntity);
		// 查询
		List list = cascadeEntityDao.findListByQuery(map);
		if(list != null && !list.isEmpty()){
			List<CascadeEntity> child = new ArrayList<>();
